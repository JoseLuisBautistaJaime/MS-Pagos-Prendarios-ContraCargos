...
public class RegistroPagoController {
	 ...
	 */
	private final Logger log = LoggerFactory.getLogger(RegistroPagoController.class);
	...
	@PostMapping(value = "/v1/registropago", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	public Response post(@RequestBody RegistroPagoDTO registroPago) {
...
//        ValidadorCadena.notNullNorEmpty(registroPago);
		...
		RegistroPagoDTO registroPagoDTO;
