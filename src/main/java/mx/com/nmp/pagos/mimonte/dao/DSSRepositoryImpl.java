...
/**
 * Nombre: DSSRepositoryImpl
 * Descripcion: Clase que implementa las operaciones
...
public class DSSRepositoryImpl implements DSSRepositoryCustom {
	...
	/**
	 * Metodo que ejecuta una consulta de regla de negocios y recibe un Array de tipo Object como respuesta
	 */
	@Override
	@Transactional
