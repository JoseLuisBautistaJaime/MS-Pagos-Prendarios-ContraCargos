 ...
 * Descripcion: Clase que expone el servicio REST para la obtencion de los registros del catalogo especificado
 *
...
@Api(value = "Servicio que permite obtener los registros de un catalogo especifico.",  description = "REST API para Catálogos",  produces = MediaType.APPLICATION_JSON_VALUE,  protocols = "http", tags = { "Catalogos" })
public class CatalogoController {
    ...
    /**
     * Metodo que expone la operacion de servicio para recuperar los registros de un catalogo especificado.
    ...
    @ApiOperation(httpMethod ="GET", value = "Regresa la informacion de un catalogo registrado en la base de datos.", tags = { "Catalogos" })
    ...
    @ApiOperation(httpMethod ="GET", value = "Regresa la lista de los nombres de extrafilter registrados en el sistema para su consulta.", tags = { "Catalogos" })
    @ApiResponses({ @ApiResponse(code = 200, response = Response.class, message = "Registros obtenidos"),
                    @ApiResponse(code = 404, response = Response.class, message = "No existen registros para el catalogo especificado"),
                    @ApiResponse(code = 500, response = Response.class, message = "Error no esperado") })
    public Response get() {
