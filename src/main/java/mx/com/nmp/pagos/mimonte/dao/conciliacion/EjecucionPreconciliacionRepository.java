...
public interface EjecucionPreconciliacionRepository extends PagingAndSortingRepository<EjecucionPreconciliacion, Long> {
	 ...
	 * @return
	 */
	@Query("SELECT new mx.com.nmp.pagos.mimonte.dto.conciliacion.EjecucionPreconciliacionDTO(c.id, e.id, e.descripcionCorta, e.descripcion, e.orderNumber, c.fechaEjecucion, c.fechaPeriodoInicio, c.fechaPeriodoFin, c.createdBy, c.createdDate, c.lastModifiedDate, c.lastModifiedBy, p.nombre ) FROM EjecucionPreconciliacion c " +
