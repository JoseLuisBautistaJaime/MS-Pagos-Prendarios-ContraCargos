...
public enum CodigoError {
	...
	NMP_PMIMONTE_BUSINESS_149("Ya existe un dia inhabil registrado para la fecha especificada",
			TipoError.CLIENTE, SeveridadError.MEDIA),
	NMP_PMIMONTE_BUSINESS_150("No hay contactos a los cuales enviar e-mail del proceso de pre-conciliacion automatizado",
			TipoError.CLIENTE, SeveridadError.MEDIA),
	NMP_PMIMONTE_BUSINESS_151("No hay contactos a los cuales enviar e-mail del proceso de conciliacion automatizado",
			TipoError.CLIENTE, SeveridadError.MEDIA),
	NMP_PMIMONTE_BUSINESS_152("Error al construir e-mail del proceso de conciliacion automatizado",
			TipoError.CLIENTE, SeveridadError.MEDIA),
	NMP_PMIMONTE_BUSINESS_153("Error al enviar e-mail del proceso de conciliacion automatizado",
			TipoError.CLIENTE, SeveridadError.MEDIA),
