 ...
 * @version 0.1
 */
public class MovimientoTransaccionalRequestDTO implements Comparable<MovimientoTransaccionalRequestDTO> {
	...
	public String toString() {
		return "MovimientoTransaccionalRequestDTO [idComerciante=" + idComerciante + ", idPedido=" + idPedido
				...
				+ ", numeroLotePago=" + numeroLotePago + ", origenTransaccion=" + origenTransaccion
				+ ", recomendacionRiesgo=" + recomendacionRiesgo + ", resultadoRevisionRiesgo="
