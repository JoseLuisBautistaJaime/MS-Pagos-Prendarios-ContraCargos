...
public final class ConciliacionConstants {
	...
	/**
	 * Mensaje que es mostrado cuando la petición no obtuvo respuesta.
	 */
	public static final String ERROR_RESPONSE_PETICION = "Error al obtener una respuesta.";


	/**
	 * Validación de sub-estatus para acciones sobre la conciliación.
	 */
	public static final  List<Long> CON_SUB_ESTATUS_ACTUALIZACION_PS = asList(SUBESTATUS_CONCILIACION_ENVIADA);
	public static final  List<Long> CON_SUB_ESTATUS_CARGA_MOV_PN = asList(SUBESTATUS_CONCILIACION_CONSULTA_MIDAS);
	public static final  List<Long> CON_SUB_ESTATUS_CARGA_MOV_PT = asList(SUBESTATUS_CONCILIACION_CONSULTA_OPEN_PAY);
	public static final  List<Long> CON_SUB_ESTATUS_CARGA_MOV_EC = asList(
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA);
	public static final  List<Long> CON_SUB_ESTATUS_MERGE_CONCILIACION = asList(SUBESTATUS_CONCILIACION_CONCILIACION);
	public static final  List<Long> CON_SUB_ESTATUS_ENVIO_CONCILIACION = asList(
	...
	public static final  List<Long> CON_SUB_ESTATUS_GENERAR_CONCILIACION = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA_COMPLETADA);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_CARGA_MOV_PN = asList(
			SUBESTATUS_CONCILIACION_CONSULTA_MIDAS_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONSULTA_MIDAS_ERROR);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_CARGA_MOV_PT = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONCILIACION_ERROR,
			SUBESTATUS_CONCILIACION_CONSULTA_OPEN_PAY_ERROR);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_CARGA_MOV_PT_VALIDACION = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONCILIACION_ERROR,
			SUBESTATUS_CONCILIACION_CONSULTA_OPEN_PAY_COMPLETADA);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_MERGE_CONCILIACION = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONCILIACION_ERROR);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_CARGA_MOV_EC = asList(
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA_ERROR);
	public static final  List<Long> CON_SUB_ESTATUS_CONCILIACION_SIN_ESTADO_CUENTA = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONSULTA_OPEN_PAY_COMPLETADA);
	public static final  List<Long> CON_SUB_ESTATUS_CONCILIACION_SIN_LAYOUT = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA_COMPLETADA);
	public static final  List<Long> CON_SUB_ESTATUS_RESULTADO_MERGE_CONCILIACION_E2 = asList(
			SUBESTATUS_CONCILIACION_CONCILIACION_COMPLETADA,
			SUBESTATUS_CONCILIACION_CONCILIACION_ERROR,
			SUBESTATUS_CONCILIACION_CONSULTA_ESTADO_DE_CUENTA_COMPLETADA);
