-- ------------------------------------------------------------------------------ --
-- ----------------- [2020-02-12 18:35:00] -------------------------------------- --
-- -- SE MODIFICA EL TIPO DE DATE A DATETIME EN TABLAS DEVOLUCIONES Y TRANSITO -- --
-- ------------------------------------------------------------------------------ --
ALTER TABLE to_movimiento_devolucion MODIFY fecha DATETIME NOT NULL;
ALTER TABLE to_movimiento_transito MODIFY fecha DATETIME DEFAULT NULL;

-- ------------------------------------------------------------------------------ --
-- ----------------- [2020-02-12 18:35:00] -------------------------------------- --
-- ----- SE RECREA EL SP DE MOVIMIENTOS TRANSITO POR CAMBIO DE TIPO DE DATO ----- --
-- ------------------------------------------------------------------------------ --
